...
class ItemsTestCase(unittest.TestCase):
    ...
    def test_add_item_to_shopping_list(self):
        ...
        forged_token = self.app.post(url_prefix+'/shoppinglists/1/items/',
                                     data=json.dumps(self.item),
                                     headers={'Content-Type': 'application/json', 'Authorization': 'abcdkff'})
        ...
        result = self.app.post(url_prefix+'/shoppinglists/1/items/', data=json.dumps(self.item),
        ...
        self.app.post(url_prefix+'/shoppinglists/', data=json.dumps(self.shopping_list),
                      headers={'Content-Type': 'application/json', 'Authorization': access_token})
        item = self.app.post(url_prefix+'/shoppinglists/1/items/', data=json.dumps(self.item),
                               headers={'Content-Type': 'application/json', 'Authorization': access_token})
    ...
    def test_update_item_in_shopping_list(self):
        ...
        self.app.post(url_prefix+'/shoppinglists/1/items/', data=json.dumps(self.item),
                      headers={'Content-Type': 'application/json',
                               'Authorization': access_token}
                      )
