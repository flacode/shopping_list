...
class ItemsTestCase(unittest.TestCase):
    ...
    def test_update_item_in_shopping_list(self):
        ...
        result = self.app.put('/shoppinglists/1/items/1',
        ...
        item = self.app.put('/shoppinglists/1/items/1',
                            data=json.dumps({"name": "new_name"}),
                            headers={'Content-Type': 'application/json',
                                     'Authorization': access_token})
        ...
        update_item = self.app.put('/shoppinglists/1/items/1',
                                   data=json.dumps({"name": "new_name"}),
                                   headers={'Content-Type': 'application/json', 
                                            'Authorization': access_token}
                                   )
    ...
    def test_delete_item_from_shopping_list(self):
        ...
        # create item
        self.app.post('/shoppinglists/1/items/',
